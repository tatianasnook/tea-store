...
const Home = () => {
  ...
  useEffect(() => {
    gsap.to(oneRef.current, {fontSize: 30, duration: 3, delay: 0})
    gsap.to(twoRef.current, {fontSize: 30, duration: 3, delay: 2})
    gsap.to(threeRef.current, {fontSize: 30, duration: 3, delay: 4})
  }, [])
